...
<body class="hold-transition login-page newbg">
  ...
  <img src="<?php echo validate_image($_settings->info('logo')) ?>" class="d-inline-block align-top titlelogo" alt="" loading="lazy">
  <h1 class="text-center text-white logintitle px-4"><b>Mega Pixel</b></h1>
