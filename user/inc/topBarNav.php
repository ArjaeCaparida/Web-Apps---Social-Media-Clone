...
<nav class="bottomdes addspace main-header navbar navbar-expand-lg navbar-light border-bottom border-4 shadow">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="btn-group nav-link text-reset">
                        <button type="button" class="btn btn-rounded badge badge-light dropdown-toggle dropdown-icon  text-reset" data-toggle="dropdown">
                          ...
                          <span class="ml-3 text-light"><?php echo ucwords($_settings->userdata('firstname').' '.$_settings->userdata('lastname')) ?></span>
